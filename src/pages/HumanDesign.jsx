...
import { ArrowRight, TrendingUp, Users, Zap, Wrench } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
            ...
            <div className="space-y-8">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-600/10 border border-red-600/30">
                  <Wrench className="w-4 h-4 text-red-500" strokeWidth={2.5} />
                  <span className="text-sm font-semibold text-red-500">human+design</span>
                </div>
              </motion.div>
      ...
      <motion.section
        ...
        transition={{ duration: 1 }} className="bg-gradient-to-br py-6 relative lg:py-32 overflow-hidden from-slate-50 via-white to-slate-50">
      ...
      <motion.section
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">We close the gap between what talent teams know they should be doing and what their systems actually enable them to do in order to scale talent management.

We close the gap by providing Talent Management as a Service (TMaaS). This approach gives you the tools, enabling technology, and actionable insights and the team to transform talent management from an event-driven process into your competitive advantage.</p>
          </motion.div>
      ...
      {/* 4. Interactive Talent Strategy Flow - WHITE */}
      <motion.div
